...
<head>
  ...
  <![endif]-->
    ...
    <!-- Chartlist chart css -->
    <link rel="stylesheet" href="{{ asset('admin/bower_components/chartist/css/chartist.css') }}" type="text/css"
        media="all">
    ...
    <!--slim-croper-->
    <link rel="stylesheet" href="{{ asset('admin/assets/css/slim.min.css') }}">
</head>
