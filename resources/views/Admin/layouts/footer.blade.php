...
<script src="{{ asset('admin/bower_components/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}">
</script>
<!--sweet alert-->
...
<!-- File upload js -->
<script src="{{ asset('admin/assets/pages/file-upload/dropzone-amd-module.min.js') }}"></script>
<!--switch component-->
<script type="text/javascript" src="{{ asset('admin/bower_components/switchery/js/switchery.min.js') }}"></script>
<!-- slim-js-->
<script src="{{ asset('admin/assets/js/slim.kickstart.min.js') }}"></script>
<!-- Custom js -->
