...
<body>
    <div class="main">
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="{{ route('register.perform') }}">
                            @csrf
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="btnSignUp" id="btnSignUp" class="form-submit"
                                    value="Register" />
                            </div>
                        </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="{{ asset('auth/assets/media/signup-image.jpg') }}" alt="sing up image">
                        </figure>
        ...
        <script src="{{ asset('auth/assets/js/jquery/jquery.min.js') }}"></script>
