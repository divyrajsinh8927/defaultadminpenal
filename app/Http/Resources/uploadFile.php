...
{
    public static function uploadImage($images,$destination_path)
    {
        if ($images === false) {
        ...
        if (isset($image['output']['data'])) {
            ...
            $output = Slim::saveFile($data, $name, $destination_path);
        ...
        if (isset($image['input']['data'])) {
            ...
            // If you want to store the file in another directory pass the directory name as the third parameter.
            $input = Slim::saveFile($data, $name, $destination_path);
